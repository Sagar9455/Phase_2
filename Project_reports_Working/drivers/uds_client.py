...
class UDSClient:
    ...
    def get_testcase_file_path(self):
         file_path = os.path.join(BASE_DIR,'supportfiles','testcase.txt')
            ...
            for step in steps:
                ...
                try:
                    ...
                    with Client(self.active_conn["conn"], request_timeout=2, config=self.active_conn["client_config"]) as client:
                        ...
                        #expected_bytes = self.clean_expected_response(expected)
                        ...
                        if response is not None:
                            ...
                            try:
                                ...
                                testcase_results.append({"tc_id": tc_id,
                                                         "step_desc": step_desc,
                                                         "status": status,
                    ...
                    testcase_results.append({"tc_id": tc_id,
                                             ...
                                             "status": status,
                                             "failure_reason": failure_reason,
                                             "expected": expected_bytes if 'expected_bytes' in locals() else [],
                                             "actual": []
                    })
                try:			 
